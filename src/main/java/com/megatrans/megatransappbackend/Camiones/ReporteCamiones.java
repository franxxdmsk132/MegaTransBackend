package com.megatrans.megatransappbackend.Camiones;
...
public class ReporteCamiones {
    ...
    private List<Camiones> listaCamiones;

    public ReporteCamiones(List<Camiones> listaCamiones) {
        super();
    ...
    private void escribirProductos(PdfPTable table) {
        for (Camiones camiones : listaCamiones) {
            table.addCell(String.valueOf(camiones.getId()));
            table.addCell(camiones.getTipo());
            table.addCell(camiones.getMarca());
            table.addCell(camiones.getModelo());
            table.addCell(camiones.getPlaca());
            table.addCell(String.valueOf(camiones.getCapacidad()));
            table.addCell(camiones.getTipo_cajon());
            table.addCell(String.valueOf(camiones.getAltura()));
            table.addCell(String.valueOf(camiones.getAncho()));
            table.addCell(String.valueOf(camiones.getLargo()));
            table.addCell(String.valueOf(camiones.getEstado()));
    ...
    public void exportarReporte(HttpServletResponse response) throws DocumentException, IOException {
        ...
        Paragraph paragraph = new Paragraph("Lista de Camiones", font);
